...
{
    vec2 axes;
    //axes.x = SampleKey(iKeyboard[1]) - SampleKey(iKeyboard[0]);
    //axes.y = (axes.x == 0.0)? SampleKey(iKeyboard[2]) - SampleKey(iKeyboard[3]) : 0.0;
    axes.x = iKeyboard[1] - iKeyboard[0];
    axes.y = (axes.x == 0.0)? iKeyboard[2] - iKeyboard[3] : 0.0;
    return axes;
}
